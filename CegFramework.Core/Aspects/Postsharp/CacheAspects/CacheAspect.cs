...
using CegFramework.Core.CrossCuttingConcerns.Caching;
using PostSharp.Aspects;

namespace CegFramework.Core.Aspects.Postsharp.CacheAspects
{
    [Serializable]
    public class CacheAspect:MethodInterceptionAspect
    {
        ...
        public override void OnInvoke(MethodInterceptionArgs args)
        {
            ...
            var key = string.Format("{0}({1})", methodName,
                string.Join(",",
                    arguments.Select(x => x != null ? x.ToString() : "<Null>")));
